...
while True:
    ...
    # Crop the painting area and recognize digits
    bbox = [(40, 65), (600, 471)]
    ...
    if np.count_nonzero(thresh) > 100:  # Only predict if there are enough non-zero pixels
        digit = prediction(thresh, model, scaler)
        cv2.putText(frame, f'Digit: {digit}', (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2, cv2.LINE_AA)
